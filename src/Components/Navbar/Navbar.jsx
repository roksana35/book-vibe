...
const Navbar = () => {
   ...
   <NavLink to="/" className={({isActive})=> isActive?'text-green-500 font-bold':'font-bold'}>Home</NavLink>
    ...
    return (
        <div className="navbar bg-base-100 lg:max-w-7xl px-4 shadow-lg sticky h-16">
  ...
  <div className="navbar-end mr-2">
    <button className="btn bg-green-500 px-4 py-2 rounded-lg text-white mr-4">Sign In</button>
    <button className="btn bg-sky-400 px-4 py-2 rounded-lg text-white">Sign Up</button>
  </div>
</div>
    );
};
